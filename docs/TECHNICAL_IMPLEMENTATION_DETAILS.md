...
**Scope:** Deep technical analysis of the codebase, algorithms, mathematical models, and data structures used in this prototype.
...
## 9. SUMO/TraCI Integration (`experiments/run_sumo_experiment.py`) — Mobility-Driven Observations
...
This is the exact order inside `experiments/run_sumo_experiment.py`.

#### 13.5.1. Sequence Diagram (Mermaid)

```mermaid
sequenceDiagram
        participant Driver as experiments/run_sumo_experiment.py
